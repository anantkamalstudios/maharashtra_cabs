        ...
        <div className="row ">
          <div className="col-lg-5 pe-lg-5 ">
            <h3 className="text-white wow fadeInDown">
              {calci?.title ?? "Want to Calculate Your Car Payment?"}
            </h3>
          ...
          <div className="col-lg-7 mb-20 wow fadeIn">
            <div className="row">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="col-md-3 col-6 mb-md-0 mb-4 d-flex flex-column align-items-center align-items-md-start"
                >
                  ...
                  <div className="position-relative">
                    {stat.label.split(" ").map((line, i) => (
                      <p key={i} className="text-lg-bold text-white">
                        {line}
                      </p>
                    ))}
                  </div>
