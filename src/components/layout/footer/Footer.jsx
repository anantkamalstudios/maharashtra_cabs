            ...
            <div className="row align-items-center">
              <div className="col-lg-5 col-md-6 text-center text-md-start">
                <h5 className="color-white wow fadeInDown">
                  Join now to see hidden deals and real-time price drops —
                  straight to your inbox!
                </h5>
              </div>
              <div className="col-lg-7 col-md-6 text-center text-md-end mt-md-0 mt-4">
                <div className="d-flex align-items-center justify-content-center justify-content-md-end"></div>
              </div>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-md-6 col-lg-3">
              <h6 className="text-linear-3">About Us</h6>
            ...
            <div className="col-md-6 col-lg-3">
              <h6 className="text-linear-3">Important Links</h6>
              <ul className="menu-footer">
                <li>
                ...
                <li>
                  <Link to="/refund-and-return">Return & Refund Policy</Link>
                </li>
                <li>
                  <Link to="/contact">Contact Us</Link>
                </li>
              ...
              <div className="col-md-6 text-md-end text-center mb-20">
                <div className="d-flex align-items-center justify-content-center justify-content-md-end">
                  ...
                  <div className="box-socials-footer d-inline-block">
                    <Link className="icon-socials icon-instagram" to="#">
                      <svg
