                  ...
                  <div className="tour-header">
                    <div className="d-flex flex-wrap align-items-center gap-4 mb-3">
                      ...
                      <Link href="#" className="text-md-medium neutral-500">
                        SKU{" "}
                        <span className="text-md-bold neutral-1000 ms-1 text-decoration-underline">
                          LVA-4125
                        </span>{" "}
                      </Link>
                      <Link href="#">
                    ...
                    <div className="d-flex align-items-center gap-3 border-bottom pb-4 mb-4">
                      <span className="text-24-medium neutral-500 text-decoration-line-through">
                        {" "}
                        $68.53{" "}
                      </span>
                    ...
                    <ul className="list-style-disc ps-3 pe-4">
                      <li className="text-md-medium neutral-1000">
                    ...
                    <div className="tour-metas mt-4 border-top pt-4">
                      <div className="tour-meta-left mb-0">
                        ...
                        <button
                          type="submit"
                          className="btn btn-primary rounded-3 gap-2 button-add-to-cart"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={16}
                    ...
                    <div className="d-flex align-items-center gap-2 mt-4">
                      ...
                      <span className="text-md-medium neutral-1000">
                        Cleaning Oils, Motor Oils, Oils &amp; Fluids
                      </span>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="collapse show" id="collapseOverview">
                        <div className="card card-body">
                          <p>
                            ...
                            the realm of compact SUVs – the Seltos K3. Dressed
                            in a captivating blue hue that exudes elegance and
                            flair, this dynamic vehicle stands as a testament to
                            innovation and style. With its sleek design
                            accentuated by striking dark wheels, the Seltos K3
                            is not merely a mode of transportation but a
                            statement of refined taste and contemporary living.
                          </p>
                          <p>
                            Prepare to embark on a journey where cutting-edge
                            technology meets unparalleled comfort, all wrapped
                            in a package of unparalleled aesthetics. Join us as
                            we delve into the world of the Seltos K3, where
                            every detail is crafted to elevate your driving
                        ...
                        <div className="card card-body">
                          ...
                          <div className="list-reviews">
                            <div className="item-review">
                              ...
                              <div className="content-review">
                                <p className="text-sm-medium neutral-800">
                                  ...
                                  The views were amazing, and the ride was very
                                  smooth. It's a great way to see Las Vegas from
                                  a different perspective. The staff were
                                  friendly and helpful. Definitely worth it! The
                                  High Roller was one of the highlights of our
                                  Las Vegas trip.
                                </p>
                              </div>
                            </div>
                            <div className="item-review">
                              ...
                              <div className="content-review">
                                <p className="text-sm-medium neutral-800">
                                  Took my family on The High Roller, and we all
                                  loved it! The kids were amazed by the views,
                                  and the adults enjoyed the experience just as
                                  much. It's suitable for all ages and
                                  definitely a highlight of our trip to Vegas.
                                  Don't miss your chance to see Las Vegas from a
                                  whole new perspective and create memories that
