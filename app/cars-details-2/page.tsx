                    ...
                    <div className="row g-3">
                      <div className="col-lg-7">
                        <div className="position-relative rounded-12 overflow-hidden">
                          <img
                            src="/assets/imgs/cars-details//banner6.png"
                            alt="Travile"
                          />
                        ...
                        <div className="d-flex gap-3">
                          <div className="d-flex gap-3 flex-column w-100">
                            <div className="rounded-12 overflow-hidden w-100">
                              <img
                                className="w-100"
                                src="/assets/imgs/cars-details//banner7.png"
                                alt="Travile"
                              />
                            </div>
                            <div className="rounded-12 overflow-hidden w-100">
                              <img
                                className="w-100"
                                src="/assets/imgs/cars-details//banner8.png"
                                alt="Travile"
                              />
                            </div>
                          </div>
                          <div className="d-flex gap-3 flex-column w-100">
                            <div className="rounded-12 overflow-hidden w-100">
                              <img
                                className="w-100"
                                src="/assets/imgs/cars-details//banner9.png"
                                alt="Travile"
                              />
                            </div>
                            <div className="rounded-12 overflow-hidden w-100">
                              <img
                                className="w-100"
                                src="/assets/imgs/cars-details//banner10.png"
                                alt="Travile"
                              />
                            </div>
                          </div>
