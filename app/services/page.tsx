                    ...
                    <div className="card-info">
                      <div className="card-title mb-3">
                        ...
                        <p className="text-md-medium neutral-500 mt-2">
                          ...
                          and weekly needs, ideal for vacations or business
                          trips.
                        </p>
                      </div>
                  ...
                  <div className="card-news background-card hover-up mb-24">
                    ...
                    <div className="card-info">
                      <div className="card-title mb-3">
                        ...
                        <p className="text-md-medium neutral-500 mt-2">
                          Convenient and cost-effective solutions for those
                          needing a vehicle for an extended period, with
                          discounted rates.
                        </p>
                      </div>
                      <div className="card-program">
                  ...
                  <div className="card-news background-card hover-up mb-24">
                    ...
                    <div className="card-info">
                      <div className="card-title mb-3">
                        ...
                        <p className="text-md-medium neutral-500 mt-2">
                          Drive in style with our selection of high-end
                          vehicles, perfect for special occasions or executive
                          travel.
                        </p>
                      </div>
                      <div className="card-program">
