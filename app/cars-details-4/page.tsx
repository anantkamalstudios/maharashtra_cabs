                  ...
                  <div className="group-collapse-expand">
                    ...
                    >
                      <div className="card card-body">
                        <p>
                          Elevate your Las Vegas experience to new heights with
                          a journey aboard The High Roller at The LINQ. As the
                          tallest observation wheel in the world, standing at an
                          impressive 550 feet tall, The High Roller offers a
                          bird's-eye perspective of the iconic Las Vegas Strip
                          and its surrounding desert landscape. From the moment
                          you step into one of the spacious cabins, you'll be
                          transported on a mesmerizing adventure, where every
                          turn offers a new and breathtaking vista of the
                          vibrant city below.
                        </p>
                        <p>
                          ...
                          With its climate-controlled cabins and immersive audio
                          ...
                          <div className="item-review">
                            ...
                            <div className="content-review">
                              <p className="text-sm-medium neutral-800">
                                ...
                                and the surrounding area. The cabins are
