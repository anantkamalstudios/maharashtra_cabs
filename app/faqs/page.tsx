          ...
          <section className="box-section background-2 py-96">
            <div className="container">
              <div className="text-center  mb-40">
                ...
                <h3 className="my-3 neutral-1000">
