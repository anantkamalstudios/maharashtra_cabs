  ...
  return (
    <>
      <Layout footerStyle={1}>
        <div className="">
          <div
            className="page-header-2 pt-130"
            style={{ backgroundColor: "#171717", paddingBottom: "6rem" }}
          >
            <div className="custom-container position-relative mx-auto">
              ...
              <div className="container position-absolute z-1 top-50 start-50 pb-70 translate-middle text-center">
                ...
                <h2 className="text-white mt-4">
                  Find the Perfect Part at the <br /> Best Price for Your
                  Vehicle's Comfort
                </h2>
              ...
              <div className="row align-items-end">
                <div className="col-md-9 mb-30 wow fadeInUp">
                  ...
                  <p className="text-lg-medium text-bold neutral-500">
                    Experience The Best Car Services In Maharashtra-cabs
                  </p>
                </div>
              </div>
            </div>
                          ...
                          <div className="card-info p-3 pt-30 border-top">
                            ...
                            <div className="card-program">
                              <ul className="list-style-disc ps-3 pe-4">
                                <li className="text-xs-medium neutral-1000">
                              ...
                              <div className="endtime pt-3 mt-3 border-top">
                                <div className="card-price">
                                  <h6 className="text-md-medium neutral-500 text-decoration-line-through">
                                    $68.53
                                  </h6>
                                </div>
                          ...
                          <div className="card-info p-3 pt-30 border-top">
                            ...
                            <div className="card-title">
                              <Link
                                ...
                                href="/shop-details"
                              >
                                Spyder® – Projector Headlight Misubisi 2024
                              </Link>
                            </div>
                            <div className="card-program">
                              <ul className="list-style-disc ps-3 pe-4">
                          ...
                          <div className="card-info p-3 pt-30 border-top">
                            ...
                            <div className="card-title">
                              <Link
                                ...
                                href="/shop-details"
                              >
                                Shell Rotella T1 SAE 30 Conventional Heavy Duty
                              </Link>
                            </div>
                            <div className="card-program">
                              <ul className="list-style-disc ps-3 pe-4">
                          ...
                          <ul className="list-filter-checkbox">
                            ...
                            <li>
                              <label className="cb-container">
                                {" "}
                                <input type="checkbox" />
                                <span className="text-sm-medium">Brakes</span>
                                <span className="checkmark" />{" "}
                              </label>
                          ...
                          <ul className="list-filter-checkbox">
                            ...
                            <li>
                              <label className="cb-container">
                                {" "}
                                <input type="checkbox" />
                                <span className="text-sm-medium">Honda</span>
                                <span className="checkmark" />{" "}
                              </label>
                              <span className="number-item">13</span>
                            </li>
                            <li>
                              <label className="cb-container">
                                {" "}
                                <input type="checkbox" />
                                <span className="text-sm-medium">Hyundai</span>
                                <span className="checkmark" />{" "}
                              </label>
                              <span className="number-item">23</span>
                            </li>
                            <li>
                              <label className="cb-container">
                                {" "}
                                <input type="checkbox" />
                                <span className="text-sm-medium">Jaguar</span>
                                <span className="checkmark" />{" "}
                              </label>
                              <span className="number-item">23</span>
                            </li>
                            <li>
                              <label className="cb-container">
                                {" "}
                                <input type="checkbox" />
                                <span className="text-sm-medium">Lexus</span>
                                <span className="checkmark" />{" "}
                              </label>
                              <span className="number-item">35</span>
                            </li>
                            <li>
                              <label className="cb-container">
                                {" "}
                                <input type="checkbox" />
                                <span className="text-sm-medium">Lotus</span>
                                <span className="checkmark" />{" "}
                              </label>
                              <span className="number-item">56</span>
                            </li>
                            <li>
                              <label className="cb-container">
                                {" "}
                                <input type="checkbox" />
                                <span className="text-sm-medium">Toyota</span>
                                <span className="checkmark" />{" "}
                              </label>
                              <span className="number-item">76</span>
                            </li>
