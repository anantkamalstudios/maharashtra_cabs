                  ...
                  <div className="d-flex justify-content-center align-items-center mt-3">
                    <ul className="list-unstyled d-flex align-items-center gap-3 change-price-plan">
                      <li>
                        <a
                          onClick={() => handleTab(1)}
                          className="active btn btn-primary monthly px-3 py-2"
                          data-type="monthly"
                        >
                          Monthly Price
                        </a>
                      ...
                      <li>
                        <a
                          onClick={() => handleTab(2)}
                          className="yearly btn btn-white px-3 py-2"
                          data-type="yearly"
                        >
                          Annual Price
                        </a>
              ...
              <div className="row">
                <div className="col-lg-3 col-sm-6 mb-lg-0 mb-4">
                  <div className="h-100 p-4 border rounded-12">
                    ...
                    <div className="d-flex">
                      ...
                      <h3 className="neutral-1000 mb-0 text-price-standard">
                        {isTab === 1 ? "19" : "49"}
                      </h3>
                      <span className="neutral-500 text-md-medium align-self-end text-type-standard">
                        /{isTab === 1 ? "month" : "year"}
                      </span>
                    </div>
                ...
                <div className="col-lg-3 col-sm-6 mb-lg-0 mb-4">
                  <div className="h-100 p-4 border rounded-12">
                    ...
                    <div className="d-flex">
                      <span className="heading-3 neutral-1000">$</span>
                      <h3 className="neutral-1000 mb-0 text-price-business">
                        {isTab === 1 ? "59" : "199"}
                      </h3>
                      <span className="neutral-500 text-md-medium align-self-end text-type-business">
                        /{isTab === 1 ? "month" : "year"}
                      </span>
                    </div>
                    <p className="text-sm-medium neutral-1000">
                ...
                <div className="col-lg-3 col-sm-6 mb-lg-0 mb-4">
                  <div className="h-100 p-4 border rounded-12">
                    ...
                    <div className="d-flex">
                      <span className="heading-3 neutral-1000">$</span>
                      <h3 className="neutral-1000 mb-0 text-price-enterprise">
                        {isTab === 1 ? "79" : "299"}
                      </h3>
                      <span className="neutral-500 text-md-medium align-self-end text-type-enterprise">
                        /{isTab === 1 ? "month" : "year"}
                      </span>
                    </div>
                    <p className="text-sm-medium neutral-1000">
          ...
          <section className="section-faqs-2 pt-80 pb-80 border-bottom background-body position-relative">
            <div className="container position-relative z-2">
              <div className="text-center mb-40 ">
                <h3 className="my-3 neutral-1000 @@classList">
                  Frequently Asked Questions
                </h3>
                <p className="text-xl-medium neutral-500 @@d-none">
