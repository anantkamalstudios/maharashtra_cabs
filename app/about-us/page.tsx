              ...
              <div className="row pb-50">
                ...
                <div className="col-lg-7 offset-lg-1">
                  <p className="text-lg-medium neutral-500">
                    Welcome to Maharashtra-cabs, your trusted partner in car
              ...
              <div className="row align-items-center justify-content-center">
                <div className="col-xl-6 col-lg-7 col-md-9 col-sm-11">
                  <div className="text-center mb-5">
                    <span className="text-xl-medium neutral-500">
                      Awesome Teams
                    </span>
                    <h3 className="section-title neutral-1000">
                      Meet Our Agents
                    </h3>
                  </div>
                </div>
                ...
                <div className="row align-items-center">
                  <div className="col-lg-5">
                    ...
                    <p className="text-lg-medium neutral-500 mb-4">
                      ...
                      should be a hassle-free experience, and we're dedicated to
                      ensuring that every customer finds the perfect vehicle for
                      their journey.
                    </p>
                    <div className="row">
                      <div className="col">
                        <ul className="list-ticks-green list-ticks-green-2">
                          ...
                          <li className="neutral-1000 pe-0">
                            Comprehensive insurance coverage for complete peace
                            of mind
                          </li>
                          <li className="neutral-1000 pe-0">
              ...
              <div className="container">
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 ps-lg-5">
                    ...
                    <h4 className="mb-4 neutral-1000">
                      Maharashtra-cabs offers clear pricing and 24/7 great
                      support.
                    </h4>
                    <p className="text-lg-medium neutral-500 mb-4">
                      ...
                      need it. At Maharashtra-cabs, your satisfaction is our top
                      priority.
                    </p>
                    <div className="row">
                      <div className="col">
