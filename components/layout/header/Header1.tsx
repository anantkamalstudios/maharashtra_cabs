...
export default function Header1({ scroll }: any) {
              ...
              <div className="header-nav">
                <nav className="nav-main-menu">
                  <ul className="main-menu">
                    ...
                    <li className="">
                      <Link className="color-white" href="/book-a-ride">
                        Book A Ride
                      </Link>
                    </li>
                    <li className="">
                      <Link className="color-white" href="/career">
                        Carrers
                      </Link>
                    </li>
                    <li className="">
                      <Link className="color-white" href="/blog-list">
                        Blog
                      </Link>
                    </li>
                    <li>
