    ...
    <>
      <section className="background-body">
        <div className="box-cta-3 background-100 py-96 mx-auto rounded-3 position-relative overflow-hidden">
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-5 pe-lg-5">
                <span className="btn btn-signin bg-white text-dark mb-4 wow fadeInDown">
                  Trusted Expertise
                </span>
          ...
          <div className="bg-overlay position-absolute bottom-0 end-0 h-75 background-brand-2 opacity-25 z-0 rounded-start-pill"></div>
        </div>
      </section>
    </>
  );
