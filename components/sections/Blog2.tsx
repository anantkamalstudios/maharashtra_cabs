        ...
        <div className="container">
          <div className="row align-items-end">
            <div className="col-md-9 mb-30 wow fadeInUp">
              <h3 className="title-svg neutral-1000 mb-15 wow fadeInUp">
                Inside &amp; Trending
              </h3>
              <p className="text-lg-medium text-bold neutral-500 wow fadeInUp">
          ...
          <div className="box-list-news wow fadeInUp mt-5">
            <div className="box-swiper">
              <Swiper
                {...swiperGroup2}
                className="swiper-container swiper-group-2"
              >
                    ...
                    <div className="card-news background-card hover-up d-md-flex mb-4">
                      <div className="card-image">
                        <Link href="/blog-details">
                          <img
                            className="w-100"
                            src="/assets/imgs/blog/blog-2/img-1.png"
                    ...
                    <div className="card-news background-card hover-up d-md-flex mb-4">
                      <div className="card-image">
                        <Link href="/blog-details">
                          <img
                            className="w-100"
                            src="/assets/imgs/blog/blog-2/img-2.png"
                            alt="Maharashtra-cabs"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="card-news background-card hover-up d-md-flex mb-4">
                      <div className="card-image">
                        <Link href="/blog-details">
                          <img
                            className="w-100"
                            src="/assets/imgs/blog/blog-2/img-3.png"
                            alt="Maharashtra-cabs"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="card-news background-card hover-up d-md-flex mb-4">
                      <div className="card-image">
                        <Link href="/blog-details">
                          <img
                            className="w-100"
                            src="/assets/imgs/blog/blog-2/img-4.png"
                            alt="Maharashtra-cabs"
                          />
                        </Link>
                      </div>
